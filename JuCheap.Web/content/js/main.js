...
$(document).ready(function () {
    function n() {
        var n = $("body > #wrapper").height() - 61;
        $(".sidebard-panel").css("min-height", n + "px")
    }
    $("#side-menu").metisMenu();
...
$(function () {
    if ($("#fixednavbar").click(function () {
        ...
        var t = localStorage.getItem("collapse_menu"),
            i = localStorage.getItem("fixednavbar"),
            r = localStorage.getItem("boxedlayout");
        t == "on" && $("#collapsemenu").prop("checked", "checked");
        i == "on" && $("#fixednavbar").prop("checked", "checked");
        r == "on" && $("#boxedlayout").prop("checked", "checked")
    }
    if (localStorageSupport) {
        var t = localStorage.getItem("collapse_menu"),
            ...
            r = localStorage.getItem("boxedlayout"),
            n = $("body");
        t == "on" && (n.hasClass("body-small") || n.addClass("mini-navbar"));
        i == "on" && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), n.addClass("fixed-nav"));
        r == "on" && n.addClass("boxed-layout")
    }
});
$(function () {
    function n(n) {
    ...
    function t(t) {
        var f = n($(t).prevAll()),
            e = n($(t).nextAll()),
            o = n($(".content-tabs").children().not(".J_menuTabs")),
            r = $(".content-tabs").outerWidth(!0) - o,
            i = 0,
            u;
    ...
    function i() {
        var f = Math.abs(parseInt($(".page-tabs-content").css("margin-left"))),
            e = n($(".content-tabs").children().not(".J_menuTabs")),
            r = $(".content-tabs").outerWidth(!0) - e,
            u = 0,
            t, i;
        if ($(".page-tabs-content").width() < r) return !1;
        for (t = $(".J_menuTab:first"), i = 0; i + $(t).outerWidth(!0) <= f;) i += $(t).outerWidth(!0), t = $(t).next();
        if (i = 0, n($(t).prevAll()) > r) {
    ...
    function u() {
        var n = $(this).attr("href"),
            ...
            r = !0,
            u, f;
        return n == undefined || $.trim(n).length === 0 ? !1 : ($(".J_menuTab").each(function () {
            return $(this).data("id") === n ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), t(this), $(".J_mainContent .J_iframe").each(function () {
                return $(this).data("id") === n ? ($(this).show().siblings(".J_iframe").hide(), !1) : !0
            })), r = !1, !1) : !0
        }), r ? (u = '<a href="javascript:;" class="active J_menuTab" data-id="' + n + '">' + e + ' <i class="fa fa-times-circle"><\/i><\/a>', $(".J_menuTab").removeClass("active"), f = '<iframe id="' + i + '" class="J_iframe" name="iframe' + i + '" width="100%" height="100%" src="' + n + '" frameborder="0" data-id="' + n + '" seamless><\/iframe>', $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(f), $(".J_menuTabs .page-tabs-content").append(u), t($(".J_menuTab.active"))) : $("iframe[name='iframe" + i + "']").attr("src", n), !1)
    }

    function f() {
        var i = $(this).parents(".J_menuTab").data("id"),
            u = $(this).parents(".J_menuTab").width(),
            r, n;
        return $(this).parents(".J_menuTab").hasClass("active") ? ($(this).parents(".J_menuTab").next(".J_menuTab").size() && (n = $(this).parents(".J_menuTab").next(".J_menuTab:eq(0)").data("id"), $(this).parents(".J_menuTab").next(".J_menuTab:eq(0)").addClass("active"), $(".J_mainContent .J_iframe").each(function () {
            if ($(this).data("id") == n) return $(this).show().siblings(".J_iframe").hide(), !1
        }), r = parseInt($(".page-tabs-content").css("margin-left")), $(this).parents(".J_menuTab").remove(), $(".J_mainContent .J_iframe").each(function () {
            if ($(this).data("id") == i) return $(this).remove(), !1
        })), $(this).parents(".J_menuTab").prev(".J_menuTab").size() && (n = $(this).parents(".J_menuTab").prev(".J_menuTab:last").data("id"), $(this).parents(".J_menuTab").prev(".J_menuTab:last").addClass("active"), $(".J_mainContent .J_iframe").each(function () {
            if ($(this).data("id") == n) return $(this).show().siblings(".J_iframe").hide(), !1
        }), $(this).parents(".J_menuTab").remove(), $(".J_mainContent .J_iframe").each(function () {
            if ($(this).data("id") == i) return $(this).remove(), !1
        }))) : ($(this).parents(".J_menuTab").remove(), $(".J_mainContent .J_iframe").each(function () {
            if ($(this).data("id") == i) return $(this).remove(), !1
        }), t($(".J_menuTab.active"))), !1
    }
    ...
    function h() {
        var n = $('.J_iframe[data-id="' + $(this).data("id") + '"]'),
            t = n.attr("src")
    }
    $(".J_menuItem").each(function (n) {
        $(this).attr("data-index") || $(this).attr("data-index", n)
    });
    $(".J_menuItem").on("click", u);
    $(".J_menuTabs").on("click", ".J_menuTab i", f);
    $(".J_tabCloseOther").on("click", e);
    $(".J_tabShowActive").on("click", o);
    $(".J_menuTabs").on("click", ".J_menuTab", s);
    $(".J_menuTabs").on("dblclick", ".J_menuTab", h);
    $(".J_tabLeft").on("click", i);
    $(".J_tabRight").on("click", r);
...
var JuCheapTabs = {
    calSumWidth: function (n) {
        var t = 0;
        return $(n).each(function () {
            t += $(this).outerWidth(!0)
        }), t
    }, scrollToTab: function (n) {
        var u = calSumWidth($(n).prevAll()),
            f = calSumWidth($(n).nextAll()),
            e = calSumWidth($(".content-tabs").children().not(".J_menuTabs")),
            i = $(".content-tabs").outerWidth(!0) - e,
            t = 0,
            r;
        if ($(".page-tabs-content").outerWidth() < i) t = 0;
        else if (f <= i - $(n).outerWidth(!0) - $(n).next().outerWidth(!0)) {
            if (i - $(n).next().outerWidth(!0) > f)
                for (t = u, r = n; t - $(r).outerWidth() > $(".page-tabs-content").outerWidth() - i;) t -= $(r).prev().outerWidth(), r = $(r).prev()
        } else u > i - $(n).outerWidth(!0) - $(n).prev().outerWidth(!0) && (t = u - $(n).prev().outerWidth(!0));
        $(".page-tabs-content").animate({
            marginLeft: 0 - t + "px"
        }, "fast")
    }, addMenuTab: function (n, t, i) {
        var r = i,
            u = n,
            s = t,
            f = !0,
            e, o;
        return $.trim(r).length === 0 ? !1 : ($(".J_menuTab").each(function () {
            return $(this).data("id") === r ? ($(this).hasClass("active") || ($(this).addClass("active").siblings(".J_menuTab").removeClass("active"), scrollToTab(this), $(".J_mainContent .J_iframe").each(function () {
                return $(this).data("id") === r ? ($(this).show().siblings(".J_iframe").hide(), !1) : !0
            })), f = !1, !1) : !0
        }), f ? (e = '<a href="javascript:;" class="active J_menuTab" data-id="' + r + '">' + s + ' <i class="fa fa-times-circle"><\/i><\/a>', $(".J_menuTab").removeClass("active"), o = '<iframe id="' + u + '" class="J_iframe" name="iframe' + u + '" width="100%" height="100%" src="' + r + '" frameborder="0" data-id="' + r + '" seamless><\/iframe>', $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(o), $(".J_menuTabs .page-tabs-content").append(e), scrollToTab($(".J_menuTab.active"))) : $("iframe[name='iframe" + u + "']").attr("src", r), !1)
    }, Rename: function (n, t) {
        var i = t + ' <i class="fa fa-times-circle"><\/i>';
        $(".J_menuTab[data-id='" + n + "']:first").html(i)
    }
}